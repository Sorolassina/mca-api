...
import html
from Excel_functions import modifier_contenu_excel
from Word_functions import modifier_contenu_word
from Text_functions import modifier_contenu_texte
from Powerpoint_functions import modifier_contenu_powerpoint
...
def traiter_zip_entier(zip_path: str, replacements: dict) -> tuple:
    ...
    mirror_dir = os.path.join(temp_dir, "mirror")
